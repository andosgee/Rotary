...
--
-- Host: localhost
-- Generation Time: Dec 01, 2021 at 11:19 PM
...
(7, 'Members backing Foodbanks', 'During the Covid related lockdown in 2020, job losses and business ...', 'During the Covid related lockdown in 2020, job losses and business closures led to a hug demand for food banks from those whose livelihoods had been upended.\r\n\r\nAs a semi-rural club with members involved in vegetable growing we started supplying vegetables to these food banks. We supply potatoes, onions, carrots and pumpkins. Some are donated and others purchased at very low prices. Due to the high standards demanded by supermarkets growers are left with seconds which are discarded due to size or minor blemishes but still of excellent quality. Each week club members collect these vegetables to deliver to food banks and in particular FoodBank Canterbury (FBC).\r\n\r\nAs of November 2021, our club has procured and delivered over 170 tonnes of vegetables. This work is on-going.\r\n\r\nFBC works with supermarkets and food manufactures, such as Fonterra and Watties. Some food is donated, and can also buy at very competitive prices. \r\n\r\nThe food is then distributed through local agencies such as churches, and a myriad of local groups – over 130 in all. This two tier system works very well. The local people have knowledge of their communities while FBC has effective and professional relationships with the food industry.', '2021-11-24', 1, 0, 1),
...
(11, 'Belfast-Kaiapoi Potato Fundraiser', 'Since 2012 our major annual fund raiser has been growing, marketing...', 'Since 2012 our major annual fund raiser has been growing, marketing and selling early season new potatoes.\r\n\r\nSeveral our members have experience in horticulture, engineering, marketing and business which has enabled us to combine our skills to make this a successful ongoing project.\r\n\r\nWe try to sell the bulk of our new potatoes in the few weeks before Christmas at several outlets. These include roadside stalls in the local area, Riccarton Market (last two Sundays before Christmas), Ohoka Hall (last two Fridays before Christmas), Burwood Hospital, Local retail outlets etc.\r\n\r\nWe rely entirely on the generosity of local landowners that allow us to use their land (this year Marshlands Rd), and a free labour force (local Rotariansand their families and friends) who donate many hours to growing, grading, packing and selling the potatoes.\r\n\r\nThis project has proven to be a winner for the club, with all members being able to contribute in some way to its success.\r\n\r\nThank You for supporting us by purchasing our 2kg blue boxes!', '2021-11-24', 1, 1, 1),
(13, 'IT Hardware Project for local schools', 'Belfast-Kaiapoi Rotary have been supplying IT Hardware (Chromebooks...', 'Belfast-Kaiapoi Rotary have been supplying IT Hardware (Chromebooks) and associated Educational Software packages to local schools in our area since 2016. \r\nRotary became involved after a presentation from a local School Principal highlighted the disparity in educational outcomes between high(er) and low(er) decile rated schools. Many Primary School pupils were moving on to local Intermediates having little or no “IT” learning experience due to a lack of resources. This put them at a major disadvantage when moving on to their future educational years, of which most pupils struggled to recover from, or, catch up to an acceptable current minimum standard.\r\nAfter much consultation, Northcote Primary was selected as our first Chromebooks recipient, when twenty-eight laptops with associated charging stations and software were purchased.\r\nThis has proven to be such an outstanding success, that Belfast-Kaiapoi Rotary have gone on to provide many other local Primary Schools with Chromebook Laptops in the ensuing years.\r\nThe feedback from the Teachers and Principals of these recipient schools has been overwhelmingly positive.\r\nThis project is ongoing for The Rotary Club of Belfast-Kaiapoi. All future enquiries to Leith at 0211426297', '2021-12-01', 1, 1, 1);
...
(25, './ass/gallery/619dcab6c1ef59.71953340.jpg', 1, 1),
(26, './ass/gallery/619dcb5815cf72.36930128.jpg', 1, 1),
(27, './ass/gallery/619dcb5edf6765.50472531.jpg', 1, 1),
(28, './ass/gallery/61a7ee581d85a7.49475308.jpg', 0, 1),
(29, './ass/gallery/61a7ee5d23d735.85775921.jpg', 0, 1),
(30, './ass/gallery/61a7ee61d49c45.87495815.jpg', 0, 1),
(31, './ass/gallery/61a7ee670b3501.30494456.jpg', 0, 1),
(32, './ass/gallery/61a7ee6b4aaf78.54254697.jpg', 0, 1);
...
--
ALTER TABLE `tbl_gallery`
  MODIFY `GID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
