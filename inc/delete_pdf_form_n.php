<?php
	$dir = "./ass/newsletters"; //Directory targeted
...
<form class="form column" method="post" name="pdf_delete">
  <h1 class="form__title column form__head">Delete Newsletter</h1>
<div class="row">
...
<div class="row">
  <button name="delete_pdf" type="submit" class="form__button form__button--delete">Delete Newsletter</button>
</div>
<div class="row">
  <?php
    echo $state;
