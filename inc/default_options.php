<div class="cards column">
  ...
  <div class="card column">
    ...
    <br>
    <a href="details_change.php" class="card__link">Click Here to change your details.</a>
  </div>
  ...
  <div class="card column">
    ...
    <br>
    <a href="create_article.php" class="card__link">Click Here to create an article.</a>
  </div>
  ...
  <div class="card column">
    ...
    <br>
    <a href="add_gallery_image.php" class="card__link">Click Here to add an image to the site.</a>
  </div>
</div>
