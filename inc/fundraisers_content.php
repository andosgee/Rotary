...
<div class="about column">
  <div class="about__heading column">
    <h1 class="about__title">Fundraising Projects in the Community</h1>
  ...
  <div class="about__main">
    ...
    <p class="info">
      ...
      We have club members who have the expertise and machinery to enable this project to be the success it has been.
      As well, all members can contribute in some way, whether it is in the growing, packing or selling.
      The potatoes are now becoming very well known around town and we have many queries each year as to when will they be available.
      We sell several thousand of the 2kg boxes each year and all proceeds go to charity.
    </p>
      <br>
      <img class="about__image" src="./media/potato_fundraiser.jpg" alt="Potato Fundraiser Image">
    <p>
      <b>Price:</b> We sell them in distinctive blue 2kg boxes for $6/box.
    </p>
    <br>
    <img class="about__image" src="./ass/gallery/618a5f4add5292.30668835.jpg" alt="Potato box Image">
    <p>
    ...
    <p>
      ...
      <ul>
        ...
        <li>Northcote School</li>
        <li>St John</li>
        <li>North Canterbury Alpine Trust</li>
        <li>Rotary Youth Leadership Award</li>
        <li>Rotary Youth Driver Awareness</li>
        <li>Foodbank Canterbury</li>
      </ul>
      In the past the money raised has also helped to relieve disaster struck areas such-as the Weesport Flood Relief, Projects in the Pacific.
      <br>
